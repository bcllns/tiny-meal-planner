          ...
          <div className="container mx-auto max-w-7xl">
            ...
            {user && userProfile && (
              <PaymentModal
                ...
                userEmail={userProfile.email}
                userId={user.id}
                isTrialUsed={userProfile.trial_used || false}
              />
            )}
              ...
              <DialogContent className="max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-base pt-4">
                    Thank you for subscribing! You now have unlimited access to the Meal Planner.
                  </DialogDescription>
                </DialogHeader>
                ...
                {!isLoading && meals.length === 0 && !error && (
                  <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                    ...
                    <h2 className="text-2xl font-bold mb-3">
                      {savedRecipeCount === 0 ? "Welcome to Meal Planner!" : "Ready to Plan Your Meals?"}
                    </h2>
