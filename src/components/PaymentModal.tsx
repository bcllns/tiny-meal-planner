    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>{isTrialUsed ? "Your 7-day free trial has ended. Subscribe to continue planning delicious meals!" : "Subscribe now to unlock unlimited meal planning"}</DialogDescription>
        </DialogHeader>
