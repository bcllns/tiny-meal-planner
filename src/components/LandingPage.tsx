...
export function LandingPage({ onGetStarted, onHowItWorks, onPrivacyPolicy, onTermsOfService }: LandingPageProps) {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Tiny Meal Planner is an AI-powered meal planning application that helps you create delicious meals for any number of people, save teh recipes, and create and easy to use shopping list.
              </p>
            </div>
